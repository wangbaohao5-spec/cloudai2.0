...
const HERO_PLATFORM_STRATEGY = [
  ...
  "主图可以有强点击力，但不能依赖未经确认的品牌、官方、授权、正品、第一、绝对化或功效承诺。",
  "主图文案应尽量围绕商品类型、材质、颜色、使用场景、视觉风格和核心卖点，优先使用“商品细节清晰”“质感展示”“核心卖点突出”“高级感视觉”“日常使用场景”“适合当前平台展示”“突出商品外观与材质”“强化第一眼吸引力”等安全表达。",
  "如果商品分析识别到疑似品牌名，但用户没有在 generationBrief / productHint 中明确确认品牌授权、自有品牌或允许使用品牌名称，请避免把品牌名作为主标题核心。",
  "不要默认写类似“YSL 圣罗兰 金管唇釉”“第一眼展现品牌质感”的标题；可改为“金色管身唇釉”“高光泽感妆效”“精致礼盒主视觉”等围绕商品类型和视觉卖点的表达。",
