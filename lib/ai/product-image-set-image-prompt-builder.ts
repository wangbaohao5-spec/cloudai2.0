...
const HERO_CLICK_IMAGE_PROMPT = [
  ...
  "这张图是主图点击图，但图中文字必须安全、克制、可商用。",
  "保持商品外观保真，不要重新设计商品，不要改变颜色、Logo、图案、版型、材质、结构、比例或关键装饰。",
  "不要生成未经确认的官方、授权、授权设计、正品、正品保证、品牌认证、平台认证、第一、最好、顶级、100%、永久、绝对、无副作用、医学功效、品牌背书、未确认品牌关系或夸张功效表述。",
  "如果品牌关系未被用户确认，不要把品牌名放在主标题中；优先使用商品类型、材质、颜色、场景和卖点描述。",
  "安全替代表达包括：商品细节清晰、质感展示、核心卖点突出、高级感视觉、日常使用场景、适合当前平台展示、突出商品外观与材质、强化第一眼吸引力。",
