...
function buildProductPackageMarkdown(data: ProductCreationCenterData) {
  ...
  return [
    ...
    "",
    "## 生成规范说明",
    "以下内容由 Vahoro 根据商品图片、商品分析结果和用户填写的生成要求辅助生成。发布或上架前，请人工确认品牌授权、材质、成分、功效、认证、检测报告、价格、销量、用户评价等信息真实、准确、可证明。",
    "",
    "Vahoro 默认会尽量避免主动生成未经确认的官方授权、正品保证、认证、医疗功效和绝对化宣传，但仍建议在正式使用前进行人工审核。",
    "",
