...
function buildProgressItems({ copywritingCount, detailPageCount, imageEditCount, imageSetCount, sceneImageCount }: ProductCreationProgressProps): ProgressItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: copywritingCount > 0 ? "标题、卖点和营销描述已进入素材包" : "在「上架文案」生成商品标题、卖点和详情描述",
    },
    {
      id: "images",
      label: "原图优化",
      ...
      description: imageEditCount > 0 ? "原图优化结果已可用于素材整理" : "在「原图优化」生成商品展示优化图",
    },
    {
      id: "image-set",
      label: "商品套图",
      ...
      description: imageSetCount > 0 ? "商品套图图片已进入素材库" : "在「商品套图」基于规划生成商品套图",
    },
    {
      id: "assets",
      label: "素材库",
    ...
    },
    {
      ...
      description: "在「素材包」复制或下载当前商品素材包",
    },
  ];
}
